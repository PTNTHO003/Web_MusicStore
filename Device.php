...
class Device
{
    ...
    private function check_device_existence($dev_name, $cate_id, $brand_id, $dev_imageurl, $dev_price)
    {
        try {
            ...
            AND DEV_PRICE = ?; ";
            $stmt = $this->conn->prepare($sql);
            $stmt->bind_param('siisi', $dev_name, $cate_id, $brand_id, $dev_imageurl, $dev_price);
            $stmt->execute();
            $result = $stmt->get_result();
    ...
    function add_device($name, $brand_id, $cate_id, $dev_image, $dev_price)
    {
        ...
        if ($this->check_device_existence($dev_name, $cate_id, $brand_id, $dev_image, $dev_price)) {
    ...
    function remove_device($dev_id, $dev_name, $cate_id, $brand_id, $dev_image, $dev_price)
    {
        if (!$this->check_device_existence($dev_name, $cate_id, $brand_id, $dev_image, $dev_price)) {
